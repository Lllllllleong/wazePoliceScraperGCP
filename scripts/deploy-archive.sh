#!/bin/bash
# Manual deployment script for the Archive Service
...
export SERVICE_NAME="archive-service"
export REGION="us-central1"
export DOCKERFILE="Dockerfile.archive"
...
export GCS_BUCKET_NAME="wazepolicescrapergcp-archive"
